...
public class CSPostConfig {
	...
	private CSPostConfig(final File image, final String remoteImageUrl, final String locale, final String language,
			final String deviceId, final Double latitude, final Double longitude, final Double altitude,
			final Integer ttl, final Integer focusX, final Integer focusY, final MultipartContent content) {
		mImage = image;
	...
	public static class Builder {
		...
		public CSPostConfig build() throws IllegalStateException {
			...
			if (null != mImage) {
				...
				image.setHeaders(new HttpHeaders().set(CONTENT_DISPOSITION,
			...
			return new CSPostConfig(mImage, mRemoteImageUrl, mLocale, mLanguage, mDeviceId, mLatitude, mLongitude,
					mAltitude, mTtl, mFocusX, mFocusY, content);
		}
